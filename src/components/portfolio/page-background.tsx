...
export function PageBackground() {
  return (
    <div aria-hidden className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
      ...
      <div className="absolute -top-[15%] -left-[10%] h-[70vh] w-[65vw] rounded-full aurora-1 opacity-100 blur-[50px]" />
      <div className="absolute top-[35%] -right-[15%] h-[65vh] w-[60vw] rounded-full aurora-2 opacity-90 blur-[50px]" />
      <div className="absolute -bottom-[15%] left-[20%] h-[60vh] w-[55vw] rounded-full aurora-3 opacity-80 blur-[50px]" />
